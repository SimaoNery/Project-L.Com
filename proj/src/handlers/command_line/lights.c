  ...
  for (int i = 0; args[i] != NULL; i++) {
    ...
    if (parsing_args) {
      if (strcmp(args[i], "-t") == 0) {
        ...
        if (i == 0) command_aux |= LIGHT_5 | LIGHT_4 | LIGHT_3 | LIGHT_2 | LIGHT_1;
        ...
        if (i == 0) command_aux &= LIGHT_4 | LIGHT_3 | LIGHT_2 | LIGHT_1;
        ...
        if (strcmp(args[i], "1") == 0) {
          ...
          printf("There is no such light: %s", args[i]);
          return;
        }
      } else {
        printf("Invalid argument: %s", args[i]);
        return;
      }
        ...
        if (time > 0) {
          if ((strcmp(string_part, "s") == 0) || (strlen(string_part) == 0)) {
            ...
            if (time <= 1440) {
              ...
              printf("Please provide a time in minutes up to 1440 and no more than that.");
              return;
            }
            ...
            if (time <= 24) {
              ...
              printf("Please provide a time in hours up to 24 and no more than that.");
              return;
            }
          } else {
          ...
          printf("Invalid time provided: %s", args[i]);
          return;
        }
        ...
        if (time > 0) {
          ...
          printf("Invalid period provided: %s", args[i]);
          return;
        }
    }
